...
WebGLRenderingContext =
  require('../../src/javascript/webgl-rendering-context').WebGLRenderingContext; // eslint-disable-line
WebGLBuffer = require('../../src/javascript/webgl-buffer').WebGLBuffer; // eslint-disable-line
WebGLFramebuffer =
  require('../../src/javascript/webgl-framebuffer').WebGLFramebuffer; // eslint-disable-line
WebGLProgram = require('../../src/javascript/webgl-program').WebGLProgram; // eslint-disable-line
WebGLRenderbuffer =
  require('../../src/javascript/webgl-renderbuffer').WebGLRenderbuffer; // eslint-disable-line
...
WebGLUniformLocation =
  require('../../src/javascript/webgl-uniform-location').WebGLUniformLocation; // eslint-disable-line
WebGLActiveInfo =
  require('../../src/javascript/webgl-active-info').WebGLActiveInfo; // eslint-disable-line
WebGLShaderPrecisionFormat =
  require('../../src/javascript/webgl-shader-precision-format').WebGLShaderPrecisionFormat; // eslint-disable-line
WebGLContextAttributes =
  require('../../src/javascript/webgl-context-attributes').WebGLContextAttributes; // eslint-disable-line
...
module.exports = function (filter) {
  return runConformance({
    ...
    createContext: function (width, height, options) {
      ...
      context.resize = context.getExtension(
