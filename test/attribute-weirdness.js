...
tape('attribute-weirdness', function (t) {
  ...
  function render(flipAttributes, flipLocations) {
    ...
    gl.bufferData(
      gl.ARRAY_BUFFER,
      new Int16Array([0, 0, 0, 0, 4, 0, 1, 0, 0, 4, 0, 1, 4, 4, 1, 1]),
      gl.STATIC_DRAW,
    );
  ...
  t.test(
    'when attributes are flipped all alpha values should be 255',
    function (t) {
  ...
  t.test(
    'when attribute locations are swapped all alpha values should NOT be 255',
    function (t) {
